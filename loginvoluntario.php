...
?>
    ...
    <head>
        ...
        <title> Human Help - Login Voluntários</title>
    ...
    <body>
        ...
        <header class="header-logar">
            ...
            <section id="showcase">
                <div class="container">
                    <br>
                    <h1 class="text-1">Voluntário, faça seu login agora!</h1>
                    <br><br>
                    <p class="text-1">Faça o login agora mesmo e encontre ONGs, Instituições para realizar trabalho voluntário!</p>
                    <br>
                    <a href="voluntario.php" class="btn btn-info btn-lg">Cadastre-se</a>
                </div>
            </section>
        </header>
        <section id="boxes">
        ...
        ?>
                <div class="container">
                    <div class="box">
                        <form id="volunt" method="post" action="logar_voluntario.php">
                            <div class="form-group">
                                <h2 id="topico">Faça seu login</h2>
                                <img src="img/gerais.png" class="image" title="Ongs">
                                <br>
                                <label>E-mail</label>
                                <input type="text" class="form-control" id="emailv" name="emailv" placeholder="Digite seu email">
                            </div>
                            <div class="form-group">
                                <label>Senha</label>
                                <input type="password" class="form-control" id="senhav" name="senhav" placeholder="Digite sua senha">
                            </div>
                            <a href="voluntario.php">Voluntário, clique aqui para se cadastrar</a>
                            <br><br>
