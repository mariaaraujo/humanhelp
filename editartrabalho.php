...
$cdtrabalho = $_GET['cdtrabalho'];
$_SESSION['cdtrabalho'] = $cdtrabalho;
...
$trab = $con->query("SELECT t.dt_trabalho, t.hr_inicio, t.hr_fim, t.ds_trabalho, t.ds_vaga, t.qt_vaga, e.cd_cep, e.nm_logradouro, e.cd_numero, e.nm_complemento, e.nm_bairro, e.nm_cidade, e.nm_estado FROM tb_trabalho as t
JOIN tb_endereco as e
ON t.cd_endereco = e.cd_endereco
WHERE t.cd_trabalho = '$cdtrabalho'");
$trab = $trab->fetch_all();
...
<body>
    <header class="header-trabalhocriado">
        ...
        <section id="showcase">
            <div class="container"><br><br><br>
                <h1 class="text-1">Editar trabalho</h1><br><br>
            </div>
        </section>
    </header>
    ...
    <section id="boxes">
        ...
        ?>
        <br>
        <form id="vaga" method="post" action="editar_trabalho.php">
        <div class="container">
            <div class="box">
            <br><br><br><br>
            <hr>
                <h3 class="text-1">Vagas criadas</h3>
                <p><h4 class="text-vgcriadas"><?php echo $qt_vaga; ?></h4></p>
            <hr><br><br>
            <hr>
            ...
            <div class="box">
                ...
                <hr>
                    ...
                    <input type="date" class="form-control" id="dttrab" name="dttrab" value="<?php echo $trab[0][0] ?>">
                    </div>

                    <div class="form-group">
                    <label id="hrinicio">Hora do início:</label>
                    <input type="time" class="form-control" id="hrinicio" name="hrinicio" value="<?php echo $trab[0][1] ?>">
                    </div>

                    <div class="form-group">
                    <label id="hrfim">Hora do fim:</label>
                    <input type="time" class="form-control" id="hrfim" name="hrfim" value="<?php echo $trab[0][2] ?>">
                    </div>

                    <div class="form-group">
                    <label for="dstrab">Título do trabalho:</label>
                    <input type="text" maxlength="150" class="form-control" id="dstrab" name="dstrab" placeholder="Informe um título para o trabalho" value="<?php echo $trab[0][3] ?>">
                    </div>

                    <div class="form-group">
                    <label for="dsvaga">Descrição da vaga:</label>
                    <input type="text" maxlength="200" class="form-control" id="dsvaga" name="dsvaga" placeholder="Informe uma breve descrição da vaga" value="<?php echo $trab[0][4] ?>">
                    </div>

                    <div class="form-group">
                    <label for="qtvaga">Quantidade de vagas:</label>
                    <input type="text" maxlength="2" class="form-control" onkeypress="return numeros(event)" id="qtvaga" name="qtvaga" placeholder="Informe a quantidade de vagas" value="<?php echo $trab[0][5] ?>">
                    </div>
                <hr>
                
                <?php echo "<center><a href=\"cancelartrab.php?cd_trabalho=$cdtrabalho\" onClick=\"return confirm('Deseja realmente cancelar o trabalho?')\">Cancelar trabalho</a></center>" ?>
            </div>
            <div class="box">
            <h3 class="text-1">Endereço do local</h3>
                ...
                <div class="form-group">
                        ...
                        <input type="text" maxlength="9" class="form-control" onkeypress="return numeros(event)" id="ceptrab" name="ceptrab" placeholder="Digite o CEP" value="<?php echo $trab[0][6] ?>">
                    </div>

                    <div class="form-group">
                        <label for="logradouro">Logradouro</label>
                        <input type="text" maxlength="100" class="form-control" onkeypress="return letras(event)" id="logradourotrab" name="logradourotrab" placeholder="Digite o logradouro" readonly value="<?php echo $trab[0][7] ?>">
                    </div>

                    <div class="form-group">
                        <label for="numero">Número</label>
                        <input type="text" maxlength="5" class="form-control" onkeypress="return numeros(event)" id="numerotrab" name="numerotrab" placeholder="Digite o número" value="<?php echo $trab[0][8] ?>">
                    </div>

                    <div class="form-group">
                        <label for="complemento">Complemento (opcional)</label>
                        <input type="text" maxlength="12" class="form-control" id="complementotrab" name="complementotrab" placeholder="Digite o complemento (opcional)" value="<?php echo $trab[0][9] ?>">
                    </div>

                    <div class="form-group">
                        <label for="estado">Estado</label>
                        <input type="text" id="estadotrab" name="estadotrab" class="form-control" placeholder="Digite o estado" readonly value="<?php echo $trab[0][12] ?>">
                    </div>

                    <div class="form-group">
                        <label for="cidade">Cidade</label>
                        <input type="text" maxlength="40" class="form-control" onkeypress="return letras(event)" id="cidadetrab" name="cidadetrab" placeholder="Digite a cidade" readonly value="<?php echo $trab[0][11] ?>">
                    </div>

                    <div class="form-group">
                        <label for="bairro">Bairro</label>
                        <input type="text" maxlength="60" class="form-control" onkeypress="return letras(event)" id="bairrotrab" name="bairrotrab" placeholder="Digite o bairro" readonly value="<?php echo $trab[0][10] ?>">
                    </div>
                </div>
                <hr>
                <input type="submit" id="editartrabalho" name="editartrabalho" class="btn btn-primary btn-lg btn-block" value="Editar trabalho">
